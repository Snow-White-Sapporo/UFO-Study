> This project is shared for viewing and personal exploration only.  
> Please do not reproduce, redistribute, or publish any part of it—modified or not—without permission.  
...
2. **Color & fonts**: Dark mode + metallic silver tone (`#C0C0C0`) ensure futuristic yet high-contrast readability.  
      ...
      • Minimal visual noise: axes, borders, and titles are removed
...
1. Power BI users in business or analytics roles  
2. Hiring teams evaluating technical capabilities in M language, Python integration, and data-driven design
...
This project is shared for viewing and personal exploration only.  
Reproduction, redistribution, or publishing of any part of this work—whether modified or unmodified—is strictly prohibited without prior permission.
